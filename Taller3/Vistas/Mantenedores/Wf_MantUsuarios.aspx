...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="alert alert-success" id="Emp" style="visibility:hidden; float:left;">
    ...
    <div class="alert alert-info" id="EmpEdit" style="visibility:hidden;float:right;" >
          <strong>Correcto!</strong> Empleado ya esta Registrado, Favor Editar su Información.
    </div>
    ...
    <table class="table">
        ...
        <tr>
            <td>RUT:</td><td><asp:TextBox ID="txtRutUsser" placeholder="Ingrese Rut" runat="server" AutoPostBack="true" onfocus="myFunction(this)" OnTextChanged="txtRutUsser_TextChanged" Height="22px"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"
                            ControlToValidate="txtSueldo" ErrorMessage="*Ingrese Valores Numericos"
                            ForeColor="Red"
                            ValidationExpression="^[0-9]*">
                </asp:RegularExpressionValidator>
            </td>
